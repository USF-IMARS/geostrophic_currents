...
### 3.3.1 Extract Dates from Selected Cruises
...
=======
  ...
  list_c() %T>% 
  print()
>>>>>>> d3282fa6c94629532ff5a5f1291cb1f66a5d605b
```
...
hycom_path <- rstudioapi::selectDirectory(path = here("..", "misc_ideas", "data", "raw", "hycom"))
...
# shelf(camcorder)
camcorder::gg_record(here("data", "plots", "camcorder2_terra2"))
